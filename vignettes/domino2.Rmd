...
fname <- paste0(pbmc_dir, "/pbmc_seurat.rds")
if (!(file.exists(fname)
      && tools::md5sum(fname) == "0cd3bf26708be10ae4a32f378c94a2b2")) {
...
download.file(
    url = paste0(data_url, "/scenic_auc_pbmc_3k.csv"),
    destfile = paste0(scenic_dir, "/auc_pbmc_3k.csv")
)

download.file(
    url = paste0(data_url, "/scenic_regulons_pbmc_3k.csv"),
