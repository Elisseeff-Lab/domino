...
The csv files created in this analysis can be used as the TF activation inputs in a dominoSignal analysis. Please see our [Getting Started](vignette("domino2")) page for more information on how to perform an analysis with dominoSignal. For a brief tutorial on the download of the necessary files for using cellphonedb, please see the [Using the cellphoneDB database](vignette("cellphonedb_vignette")) vignette.
