...
In this tutorial, we will use the domino object we built on the [Getting Started](vigenttes("domino2")) page. If you have not yet built a domino object, you can do so by following the instructions on the [Getting Started](vignette("domino2")) page.
