...
In order to better implement some of the changes that have been made in dominoSignal, the structure of the domino object has been modified. Here, we describe the data that is stored in the domino object, as well as how best to access this data.
...
data_url <- "https://zenodo.org/records/10884027/files/pbmc_domino_built.rds"
tmp_path <- paste0(tempdir(), "/pbmc_domino_built.rds")
if (!(file.exists(tmp_path) &&
        tools::md5sum(tmp_path) == "c1ba759a11b61dd36618f71c84f0aa13")) {
  download.file(url = data_url, destfile = tmp_path)
}
