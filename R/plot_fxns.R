...
circos_ligand_receptor <- function(dom, receptor, ligand_expression_threshold = 0.01, cell_idents = NULL,
    ...
    # create a scaled mean expression plot for coord widths greater than 1 by dividing by the
    # max expression [range (0-1)] scaled.mean will only be used when the max expression is > 1
